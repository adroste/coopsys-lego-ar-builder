...
\begin{center}
\textbf{\huge Visual Support for operation manuals}
\end{center}\vskip1em

\noindent We researchers want to look if the support of operation manual through modern technologies like AR is usefull and if it is nessecary. If you've participated one of the evalutaion scenes of our prototype please fill it all out.
...
\Qitem{ \Qq{Your age:} \Qline{1.5cm} }

\Qitem{ \Qq{Your gender:} \hskip0.4cm \QO{male} \hskip0.5cm \QO{female}  \hskip0.5cm \QO{other} }

\Qitem{ \Qq{Do you use operation manuals regulary?} \hskip0.4cm \QO{Yes} \hskip0.5cm \QO{No}}

\section*{About the prototype}

\Qitem{ \Qq{Wich kind of manual you've used?} \par
	\Qtab{3cm}{\QO{AR supportd manual} \hskip0.5cm \QO{normal paper manual}}}

\Qitem{ \Qq{I feel well supported through the manual} \par
	 \Qtab{3cm}{horrible \Qrating{5} fantastic}}

\Qitem{ \Qq{I've the feeling that some support for the collaborative task could be helpful} \par
	\Qtab{3cm}{totally disagree \Qrating{5} totally agree}}


\Qitem{ \Qq{Please describe you're impressions during testing the prototype:} \Qlines{5} }

\Qitem{ \Qq{Some further space for you're comments:} \Qlines{5} }
